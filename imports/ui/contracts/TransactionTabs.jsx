...
import {
  Card, CardBody, CardHeader, Col, Nav, NavItem, NavLink, Row, TabContent, TabPane,
} from 'reactstrap';
          ...
          <CardBody>
            <Nav tabs className="tx-types">
              <NavItem>
                ...
                >
                  <T>transactions.transfer</T>
                  {' '}
                  (
                  {numbro(this.state.transferTxs.length).format('0,0')}
                  )
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                >
                  <T>transactions.staking</T>
                  {' '}
                  (
                  {numbro(this.state.stakingTxs.length).format('0,0')}
                  )
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                >
                  <T>transactions.distribution</T>
                  {' '}
                  (
                  {numbro(this.state.distributionTxs.length).format('0,0')}
                  )
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                >
                  <T>transactions.governance</T>
                  {' '}
                  (
                  {numbro(this.state.governanceTxs.length).format('0,0')}
                  )
                </NavLink>
              </NavItem>
              <NavItem>
                ...
                >
                  <T>transactions.slashing</T>
                  {' '}
                  (
                  {numbro(this.state.slashingTxs.length).format('0,0')}
                  )
                </NavLink>
              </NavItem>
            </Nav>
